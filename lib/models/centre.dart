...
class Centre {
  int id;
  String nom, type, appartenance, adresse, phone, longitude, latitude, provinces, zones;
  Centre (this.id, this.nom, this.type, this.appartenance, this.adresse, this.phone, this.longitude, this.latitude, this.provinces, this.zones);
}
