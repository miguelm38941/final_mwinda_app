                ...
                return snapshot.data.documents.isNotEmpty
                    ? ListView(
                        children: snapshot.data.documents
                          ...
                          debugPrint("****** " + document['groupchat'].toString());
                          debugPrint(
                              "print+---- " + Global.Username.toString());
                          return Column(
                            children: <Widget>[
                              if ((document['msgby'] != null) || (document['groupchat'] == null) || (document['groupchat'] == true))
                                new ListTile(
                                  onTap: () {
                                    ...
                                    Global.EditGroup = false;
                                    Global.ChatTitle = (Global.Username ==
                                            document['name'])
                                        ? document['msgby'].toString()
                                  ...
                                  title: new Text(
                                    (Global.Username == document['name'])
                                        ? document['msgby'].toString()
                                        : document['name'],
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold),
                                  ),
                                  subtitle: document['msgby'] == null
                              ...
                              if ((document['msgby'] != null) && (document['groupchat'] == false))
                                Divider(
                                  height: 2,
                                  thickness: 2,
                                )
                            ...
                            children: <Widget>[
                              ...
                              RaisedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  print(await AvailableUser(context,
